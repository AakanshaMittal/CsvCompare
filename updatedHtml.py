...
def parse_args():
   ...
   p.add_argument("--start-row", default=4, type=int, help="Starting row number for data comparison (default 4)")
   p.add_argument("--header-group-row-file1", default=2, type=int, help="Header GROUP row for File1 (default 2)")
   p.add_argument("--header-detail-row-file1", default=3, type=int, help="Header DETAIL row for File1 (default 3)")
   p.add_argument("--header-group-row-file2", default=2, type=int, help="Header GROUP row for File2 (default 2)")
   p.add_argument("--header-detail-row-file2", default=3, type=int, help="Header DETAIL row for File2 (default 3)")
